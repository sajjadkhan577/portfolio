...
export const initialProjects: Project[] = [
  {
    ...
    result: 'Eliminated $4,800/year in third-party LMS SaaS fees. Enrolled 1,200+ active students in the first cohort with zero payment verification backlogs and a 94% course completion rate.',
    tech: ['PHP', 'MySQL', 'JavaScript', 'Tailwind CSS', 'Bootstrap'],
    cover_image_url: '/assets/images/project_course_platform_1790246238322.jpg',
    gallery: ['/assets/images/project_course_platform_1790246238322.jpg'],
    live_url: '[link]',
    repo_url: '',
  ...
  },
  {
    ...
    result: 'Diverted 3.2 tons of reusable goods from landfills in the first 6 months. Streamlined 800+ donation requests through automated status tracking and matched donors with vetted recipients 3x faster.',
    tech: ['Node.js', 'Express', 'MongoDB', 'JavaScript', 'Tailwind CSS'],
    cover_image_url: '/assets/images/profile image.jpeg',
    gallery: ['/assets/images/profile image.jpeg'],
