  ...
  const steps = [
    {
      ...
      icon: <Compass className="w-6 h-6 text-[var(--accent-color)]" />,
      description:
    ...
    },
    {
      ...
      icon: <Layers className="w-6 h-6 text-[var(--accent-color)]" />,
      description:
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((item) => (
          <Card
            key={item.step}
            hoverEffect
            className="border-[var(--border-color)] bg-[var(--bg-surface)]/80 p-6 flex flex-col justify-between relative group"
          >
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-mono font-bold text-[var(--border-glow)] group-hover:text-[var(--accent-color)]/60 transition-colors">
                  {item.step}
                </span>
              </div>
            ...
            <div className="pt-4 mt-4 border-t border-[var(--border-color)] text-xs font-mono text-[var(--accent-color)] flex items-center gap-1.5">
